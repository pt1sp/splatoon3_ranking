...
if ($tableName == "all") {
    $sql = "SELECT *, ROW_NUMBER() OVER () AS 順位 FROM ( SELECT 名前,id,武器,パワー,'ネッシー派' AS 陣営 FROM uma_05_01
    ...
    $sql = "SELECT *, ROW_NUMBER() OVER () AS 順位 FROM ( SELECT * FROM (  SELECT 名前,id,武器,パワー,'ネッシー派' AS 陣営 FROM uma_05_01
    UNION ALL SELECT 名前,id,武器,パワー,'宇宙人派' AS 陣営 FROM uma_05_02
    UNION ALL SELECT 名前,id,武器,パワー,'雪男派' AS 陣営 FROM uma_05_03 ) AS aaa
